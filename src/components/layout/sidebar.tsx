    ...
    <>
        ...
        <SheetContent side="left" className="w-[20rem] gap-0 p-0">
          <SheetHeader className="border-b-[0.5px] border-border/60 px-5 py-4 text-left">
            <SheetTitle className="flex items-center gap-3">
              <span className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border-[0.5px] border-border/60 bg-primary/10">
                <Image
                  src={LOGO_IMAGE_URL}
            ...
            {visibleNavigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    'link-hover link-hover--slide flex min-h-11 items-center gap-3 rounded-lg px-3 text-sm font-medium transition-colors',
                    isActive
          ...
          <div className="border-t-[0.5px] border-border/60 px-4 py-4">
            ...
            <Button
              variant="ghost"
              className="h-10 w-full justify-start gap-3 rounded-lg text-sm font-medium text-muted-foreground hover:bg-destructive/10 hover:text-destructive"
      ...
      <header className="fixed left-0 right-0 top-0 z-40 h-14 border-b-[0.5px] border-border/60 bg-background/70 shadow-sm backdrop-blur-2xl saturate-[1.8]">
        <div className="mx-auto flex h-full max-w-[1440px] items-center justify-between gap-4 px-4 sm:px-6">
          ...
          >
            <div className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border-[0.5px] border-border/60 bg-primary/10">
              <Image
                src={LOGO_IMAGE_URL}
                alt="ScholarTrack Logo"
                width={28}
            ...
            {visibleNavigationItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  aria-current={isActive ? 'page' : undefined}
                  className={cn(
                    'link-hover link-hover--slide flex h-9 items-center gap-2 rounded-lg px-3 text-sm font-medium transition-colors',
                    isActive
                      ? 'bg-primary/10 text-primary font-semibold'
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild className="hidden sm:flex">
                <Button
                  variant="ghost"
                  className="h-10 gap-2 rounded-lg border-[0.5px] border-transparent px-2 text-foreground hover:border-border/60 hover:bg-accent"
                >
            ...
            <Button
              ...
              className="xl:hidden text-foreground hover:bg-accent"
