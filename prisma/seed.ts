...
async function main() {
  ...
  await Promise.all([
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[0].id,
        scholarshipId: scholarships[9].id,
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[0].id,
        scholarshipId: scholarships[26].id,
        awardDate: new Date('2025-11-25'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(20000),
        scholarshipStatus: 'Active',
      },
    }), // TES
  ]);
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(7000),
        scholarshipStatus: 'Active',
      },
    }), // Working Scholars
    prisma.studentScholarship.create({
      data: {
        studentId: students[1].id,
        scholarshipId: scholarships[21].id,
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[1].id,
        scholarshipId: scholarships[28].id,
        awardDate: new Date('2025-12-22'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(12000),
        scholarshipStatus: 'Active',
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[25].id,
        awardDate: new Date('2025-12-20'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2026-2027',
        grantAmount: new Prisma.Decimal(25000),
        scholarshipStatus: 'Active',
      },
    }), // StuFAPs
    prisma.studentScholarship.create({
      data: {
        studentId: students[2].id,
        scholarshipId: scholarships[32].id,
        awardDate: new Date('2025-12-25'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(8000),
        scholarshipStatus: 'Active',
      },
    }), // Employees Ward BED/SHS
    prisma.studentScholarship.create({
      data: {
        studentId: students[3].id,
        scholarshipId: scholarships[23].id,
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[3].id,
        scholarshipId: scholarships[24].id,
        awardDate: new Date('2026-01-07'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(18000),
        scholarshipStatus: 'Active',
      },
    }), // Acevedo Grant
  ]);
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[22].id,
        awardDate: new Date('2026-01-05'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(12000),
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[4].id,
        scholarshipId: scholarships[30].id,
        awardDate: new Date('2026-01-07'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(22000),
        scholarshipStatus: 'Active',
      },
    }), // Tulong Dunong
  ]);
  ...
  await Promise.all([
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[5].id,
        scholarshipId: scholarships[14].id,
        awardDate: new Date('2026-01-12'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[5].id,
        scholarshipId: scholarships[16].id,
        awardDate: new Date('2026-01-13'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(8000),
        scholarshipStatus: 'Active',
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[7].id,
        awardDate: new Date('2026-01-11'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(10000),
        scholarshipStatus: 'Active',
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[6].id,
        scholarshipId: scholarships[15].id,
        awardDate: new Date('2026-01-13'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(12000),
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[6].id,
        scholarshipId: scholarships[19].id,
        awardDate: new Date('2026-01-14'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(10000),
        scholarshipStatus: 'Active',
  ...
  await Promise.all([
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[7].id,
        scholarshipId: scholarships[13].id,
        awardDate: new Date('2026-01-14'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(6000),
        scholarshipStatus: 'Active',
      },
    }), // Yearbook SHS
    prisma.studentScholarship.create({
      data: {
        studentId: students[7].id,
        scholarshipId: scholarships[20].id,
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[5].id,
        awardDate: new Date('2026-01-12'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(5000),
        scholarshipStatus: 'Active',
      },
    }), // School Grant GS/JHS
    prisma.studentScholarship.create({
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[8].id,
        scholarshipId: scholarships[12].id,
        awardDate: new Date('2026-01-16'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(12000),
        scholarshipStatus: 'Active',
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[8].id,
        awardDate: new Date('2026-01-12'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(10000),
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[11].id,
        awardDate: new Date('2026-01-13'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(10000),
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[10].id,
        scholarshipId: scholarships[17].id,
        awardDate: new Date('2026-01-17'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(7000),
        scholarshipStatus: 'Active',
  ...
  await Promise.all([
    prisma.studentScholarship.create({
      data: {
        ...
        scholarshipId: scholarships[10].id,
        awardDate: new Date('2026-01-14'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(8000),
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[12].id,
        scholarshipId: scholarships[11].id,
        awardDate: new Date('2026-01-19'),
        startTerm: '1st Semester 2025-2026',
        endTerm: '2nd Semester 2025-2026',
        grantAmount: new Prisma.Decimal(9000),
        scholarshipStatus: 'Active',
      },
    }), // UTFI BED
  ]);
  ...
  await Promise.all([
    ...
    prisma.studentScholarship.create({
      data: {
        studentId: students[13].id,
        scholarshipId: scholarships[18].id,
  ...
  // percentSubsidy = 0.15% for all students
  // amountSubsidy = totalFees × 0.0015 (to get 0.15% when divided by totalFees × 100)
  await Promise.all([
    // College - 0.15% subsidy
    prisma.studentFees.create({
      data: {
        ...
        amountSubsidy: new Prisma.Decimal(75),
        percentSubsidy: new Prisma.Decimal(0.15),
    ...
    prisma.studentFees.create({
      data: {
        ...
        amountSubsidy: new Prisma.Decimal(67.5),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    ...
    prisma.studentFees.create({
      data: {
        ...
        miscellaneousFee: new Prisma.Decimal(3000),
        laboratoryFee: new Prisma.Decimal(7000),
        amountSubsidy: new Prisma.Decimal(72),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    ...
    prisma.studentFees.create({
      data: {
        studentId: students[3].id,
        tuitionFee: new Prisma.Decimal(28000),
        otherFee: new Prisma.Decimal(4000),
        miscellaneousFee: new Prisma.Decimal(3000),
        laboratoryFee: new Prisma.Decimal(5000),
        amountSubsidy: new Prisma.Decimal(60),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    ...
    prisma.studentFees.create({
      data: {
        ...
        miscellaneousFee: new Prisma.Decimal(3000),
        laboratoryFee: new Prisma.Decimal(5000),
        amountSubsidy: new Prisma.Decimal(63),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    }),
    // Senior High - 0.15% subsidy
    prisma.studentFees.create({
      data: {
        studentId: students[5].id,
        ...
        amountSubsidy: new Prisma.Decimal(37.5),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    ...
    prisma.studentFees.create({
      data: {
        ...
        amountSubsidy: new Prisma.Decimal(30),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
    ...
    prisma.studentFees.create({
      data: {
        ...
        amountSubsidy: new Prisma.Decimal(22.5),
        percentSubsidy: new Prisma.Decimal(0.15),
        term: '1st Semester 2025-2026',
        academicYear: '2025-2026',
      },
  ...
  await Promise.all([
    ...
    prisma.disbursement.create({
      data: {
        studentId: students[2].id,
        scholarshipId: scholarships[25].id,
        disbursementDate: new Date('2026-02-15'),
    ...
    prisma.disbursement.create({
      data: {
        studentId: students[3].id,
        scholarshipId: scholarships[0].id,
        disbursementDate: new Date('2026-02-20'),
    ...
    prisma.disbursement.create({
      data: {
        studentId: students[5].id,
        scholarshipId: scholarships[4].id,
        disbursementDate: new Date('2026-02-22'),
        amount: new Prisma.Decimal(7500),
        term: '1st Semester 2025-2026',
        method: 'Bank Transfer',
      },
    ...
    prisma.disbursement.create({
      data: {
        studentId: students[6].id,
        scholarshipId: scholarships[7].id,
        disbursementDate: new Date('2026-02-23'),
        amount: new Prisma.Decimal(5000),
        term: '1st Semester 2025-2026',
        method: 'Check',
      },
    ...
    prisma.disbursement.create({
      data: {
        studentId: students[8].id,
        scholarshipId: scholarships[9].id,
        disbursementDate: new Date('2026-02-25'),
        amount: new Prisma.Decimal(7500),
        term: '1st Semester 2025-2026',
        method: 'Bank Transfer',
      },
